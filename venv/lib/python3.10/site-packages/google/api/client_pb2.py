...
ClientLibraryOrganization = enum_type_wrapper.EnumTypeWrapper(_CLIENTLIBRARYORGANIZATION)
...
_JAVASETTINGS_SERVICECLASSNAMESENTRY = _JAVASETTINGS.nested_types_by_name['ServiceClassNamesEntry']
...
CommonLanguageSettings = _reflection.GeneratedProtocolMessageType('CommonLanguageSettings', (_message.Message,), {
...
ClientLibrarySettings = _reflection.GeneratedProtocolMessageType('ClientLibrarySettings', (_message.Message,), {
...
Publishing = _reflection.GeneratedProtocolMessageType('Publishing', (_message.Message,), {
...
JavaSettings = _reflection.GeneratedProtocolMessageType('JavaSettings', (_message.Message,), {

  'ServiceClassNamesEntry' : _reflection.GeneratedProtocolMessageType('ServiceClassNamesEntry', (_message.Message,), {
...
CppSettings = _reflection.GeneratedProtocolMessageType('CppSettings', (_message.Message,), {
...
PhpSettings = _reflection.GeneratedProtocolMessageType('PhpSettings', (_message.Message,), {
...
PythonSettings = _reflection.GeneratedProtocolMessageType('PythonSettings', (_message.Message,), {
...
DotnetSettings = _reflection.GeneratedProtocolMessageType('DotnetSettings', (_message.Message,), {
...
RubySettings = _reflection.GeneratedProtocolMessageType('RubySettings', (_message.Message,), {
...
GoSettings = _reflection.GeneratedProtocolMessageType('GoSettings', (_message.Message,), {
...
MethodSettings = _reflection.GeneratedProtocolMessageType('MethodSettings', (_message.Message,), {

  'LongRunning' : _reflection.GeneratedProtocolMessageType('LongRunning', (_message.Message,), {
