...
"""
import re
<<<<<<< HEAD:venv/lib/python3.10/site-packages/setuptools/_distutils/versionpredicate.py
...
re_paren = re.compile(r"^\s*\((.*)\)\s*$")  # (list) inside of parentheses
>>>>>>> 63c587b5f623b9cf60f81e2f967798a80ca5fec9:venv/lib/python3.12/site-packages/setuptools/_distutils/versionpredicate.py
