...
<<<<<<< HEAD:venv/lib/python3.10/site-packages/setuptools/command/install_lib.py
...
=======
>>>>>>> 63c587b5f623b9cf60f81e2f967798a80ca5fec9:venv/lib/python3.12/site-packages/setuptools/command/install_lib.py
    def run(self):
        self.build()
