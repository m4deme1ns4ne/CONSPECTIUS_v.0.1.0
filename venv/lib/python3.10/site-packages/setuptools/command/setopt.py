...
def config_file(kind="local"):
    ...
    if kind == 'local':
        return 'setup.cfg'
    if kind == 'global':
<<<<<<< HEAD:venv/lib/python3.10/site-packages/setuptools/command/setopt.py
        return os.path.join(
...
>>>>>>> 63c587b5f623b9cf60f81e2f967798a80ca5fec9:venv/lib/python3.12/site-packages/setuptools/command/setopt.py
